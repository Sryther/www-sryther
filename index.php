...
<section class="cd-section">
    <div style="flex-direction: row; justify-content: space-around;">
        <div style="padding: 5em; background-color: rgba(0, 0, 0, 0.2)">
            ...
            <h3><u>Certified</u> Kubernetes administrator</h3>
            <h4>I'm convinced about the strength and robustness of Infrastructure as Code.</h4>
            <p class="panel">
                <img
                        width="32px"
                        height="32px"
                        data-toggle="popover"
                        data-trigger="hover"
                        data-content="Terraform"
                        data-placement="top"
                        src="/assets/img/terraform.png"
                        alt="Terraform icon"
                />
                <img
                        width="32px"
                ...
                <img
                        ...
                        data-toggle="popover"
                        data-trigger="hover"
                        data-content="Bitbucket CI"
                        data-placement="top"
                        src="/assets/img/bitbucket.png"
                        alt="Bitbucket"
                />
            </p>
            <h4>And worked on many providers</h4>
            <p class="panel">
                <img
                        width="32px"
                        height="32px"
                        data-toggle="popover"
                        data-trigger="hover"
                        data-content="OVH - Public Cloud"
                        data-placement="top"
                        src="/assets/img/ovh.png"
                        alt="OVH icon"
                />
                <img
                        width="32px"
                ...
                <img
                        ...
                        data-toggle="popover"
                        data-trigger="hover"
                        data-content="Scaleway"
                        data-placement="top"
                        src="/assets/img/scaleway.png"
                        alt="Scaleway icon"
                />
                <img
                        width="32px"
                        ...
                        data-toggle="popover"
                        data-trigger="hover"
                        data-content="Dassault Systèmes Outscale"
                        data-placement="top"
            ...
            <p>
                <a class="left after" href="https://fr.linkedin.com/in/paul-rey" target="_blank">More information about my experience on LinkedIn</a>
            </p>
        </div>
    ...
    <div style="flex-direction: row; justify-content: space-around;">
        <div style="text-align: left; width: 50%;">
            ...
            <a class="left after"
               ...
               data-toggle="popover"
               data-trigger="hover"
               title="I'm not on social network... You'll have to be patient if you want more."
               data-html="true"
